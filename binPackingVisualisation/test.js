...
function generateContainerLayers(obj) {
    ...
    obj.forEach(function (entry) {
        ...
        var divtag= $("<div id=\"containerdiv"+containerCounter+"\" >");
        ...
        layers.forEach(function (zvalue) {
            layerCounter++;
            divtag = $("<div id=\"layer"+containerCounter+""+layerCounter+"\"style=\'float: left\'>");
        ...
        $("#visualisation").append("<br><br><br><br><br><br><br><br><br><br><br><br><br><br>");
